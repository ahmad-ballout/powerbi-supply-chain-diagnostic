...
* **Glossary :** Guide de référence rapide expliquant les acronymes clés et la méthodologie de calcul des métriques (OTIF, SLA, Lead Time, AOV, etc.).
...
* **Bouton Réinitialiser (Reset Slicers) :** Bouton d'action permettant de réinitialiser instantanément tous les filtres appliqués sur la page.
...
* **Mesures DAX Avancées :** Création de formules DAX sur-mesure pour le calcul dynamique de l'OTIF %, du panier moyen (AOV), des jours de retard moyens et des indicateurs de décalage temporel.
